...
def run_scenario():
    ...
    # ──────────────────────────────────────────────────────
    # Scenario 1: Valid handoff chain (happy path)
    # ──────────────────────────────────────────────────────
    print("─" * 70)
    ...
    # ──────────────────────────────────────────────────────
    # Scenario 4: Schema violation (bad data)
    # ──────────────────────────────────────────────────────
    print("─" * 70)
    ...
    # ──────────────────────────────────────────────────────
    # Scenario 5: Large transaction without approval
    # ──────────────────────────────────────────────────────
    print("─" * 70)
